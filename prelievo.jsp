...
<body>
  <%@ page import="java.io.*,java.util.*" %>
    ...
    <div class="has-text-centered">
        <h1 class="is-size-2 is-size-3-mobile has-text-centered">Prelievo</h1>
        <form action="gestioneTransazioni.jsp" method="post">
            <div class="field">
                <div class="control">
                    <label class="label" for="importo">Inserisci l'importo da prelevare: </label>
                    <div class="columns is-mobile is-centered">
                        <div class="column is-one-third-mobile is-one-third-desktop">
                          ...
                          <input type="hidden" name="tipo" value="Prelievo">
                        </div>
                    </div>
                    <button class="button is-dark">Preleva</button>
                </div>
            </div>
        </form>
    </div>
